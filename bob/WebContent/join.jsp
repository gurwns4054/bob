...
<body>
회원가입 폼을 복사할 것이다
<a href = "http://localhost:8080/bob/register.jsp?wUserID=&wUserPW=&wUserPWConfirm=&wUserName=&wUserGender=1&wUserCellPhone=&wUserEmail=&wRestAddress=&x=53&y=9">get으로 보냄</a>
<center>
        ...
        <table width="700" height="600" cellpadding="0" style="border-collapse:collapse; font-size:9pt;">
            ...
            <tr>
                ...
                <td>
                  ...
                  <input type="text" name="wRestAddress" placeholder="주소" size="70" />
                </td>
            </tr>
